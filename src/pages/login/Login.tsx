...
return (
  <>
    <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center bg-container" style={{ fontFamily: 'Share Tech, sans-serif' }}>
      {/* Adicionei a classe 'bg-container' à div abaixo */}
      <form className="flex justify-center items-center flex-col w-1/2 gap-4 p-0 " onSubmit={login}>
        <h2 className="text-Secundary text-5xl ">Entrar</h2>
        <div className="flex flex-col w-full text-Secundary">
          ...
          <input
            ...
            name="usuario"
            placeholder="Usuario"
            className="border-2 border-secundary rounded p-2 bg-Secundary"
        ...
        <button type="submit" className="rounded bg-Secundary hover:bg-indigo-900 text-Primary font-bold w-1/2 py-2 flex justify-center">
          {isLoading ? (
            <RotatingLines
              strokeColor="white"
              strokeWidth="5"
